...
This is **not** 1:1 compatible with py-slippi and does **not** have py-slippi as a dependancy. It's based on the py-slippi parser, but I've made several breaking changes to the API that require at >=python 3.10. Some names and structures are different as well (e.g. "damage" -> "percent", Metadata.Player.Netplay class has been flattened into Metadata.Player)
